        ...
        private void OnEdit() {
            ...
            try {
                ...
                var win = new EditPreset {
                    ...
                    // Owner set to MainWindow.
                    Owner = GameReady ? Application.Current.MainWindow : null
                };

                // Get the view model.
                var vm = win.DataContext as EditPresetViewModel;
                vm.EditPreset = SelectedItem.Normalized();
                vm.GameReady = GameReady;
                // Dialog comes back as true.
                if (win.ShowDialog() == true) {
                    // Set the selected name to the viewmodel's name.
                    //SelectedItem.Name = vm.EditPreset.Name;
                    SelectedItem = vm.EditPreset;
